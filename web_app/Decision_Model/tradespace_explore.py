...
class Tradespace:
    ...
    def plotTS(self, optimal_set):
        ...
        # Make three 2-D plots
        # plt.subplots_adjust(left=0.2, bottom=0.5, right=0.2, top=0.9, wspace=0.2, hspace=0.9)
        ...
        ax1.plot(df['cost'], df['perf'], '.b', markersize=8, label='Non Pareto-optimal')
        ax1.plot(optimal_set['cost'], optimal_set['perf'], '.y', markersize=8, label='Pareto optimal')
        ax1.set_xlabel('Cost')
        ax1.set_ylabel('Performance')
        ax1.set_title('Performance vs. Cost')

        ax2.plot(df['cost'], df['risk'], '.b', markersize=8, label='Non Pareto-optimal')
        ax2.plot(optimal_set['cost'], optimal_set['risk'], '.y', markersize=8, label='Pareto optimal')
        ax2.set_xlabel('Cost')
        ax2.set_ylabel('Risk')
        ax2.set_title('Risk vs. Cost')

        ax3.plot(df['perf'], df['risk'], '.b', markersize=8, label='Non Pareto-optimal')
        ax3.plot(optimal_set['perf'], optimal_set['risk'], '.y', markersize=8, label='Pareto optimal')
        ax3.set_xlabel('Risk')
        ax3.set_ylabel('Performance')
        ax3.set_title('Performance vs. Risk')
